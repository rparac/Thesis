...
def run(cmd_args):
    ...
    standard_preds = json.loads(open(cache_dir + '/digit_predictions/softmax/standard_test_set_old.json').read())
    rotated_preds = json.loads(open(cache_dir + '/digit_predictions/softmax/rotated_test_set_old.json').read())
