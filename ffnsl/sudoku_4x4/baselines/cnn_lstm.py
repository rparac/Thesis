...
from ffnsl.sudoku_4x4.experiment_config import custom_args, process_custom_args
from ffnsl.utils import add_cmd_line_args
...
class SudokuNet(nn.Module):
    def __init__(self, batch_size=8, num_embeddings=5, seq_len=16, embedding_dim=32,
        ...
        self.lstm = nn.LSTM(7, hidden_size=lstm_hidden, num_layers=1, bidirectional=True)
...
if __name__ == '__main__':
    cmd_args = add_cmd_line_args(desc='CNN-LSTM Baseline Sudoku 4x4 task.', custom_args=custom_args)
